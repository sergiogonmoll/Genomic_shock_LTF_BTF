...
countData <- read.csv("Counts_final_TElocal.csv",h=T,row.names=1)
colnames(countData)
...
acu_hec_WTEs_l<- subset(contrast_hec.cin_RUV_l_TEs, unlist(strsplit(contrast_hec.cin_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin_RUV_l_TEs@rownames),4)] %in% W_chrTEs$V13)
sup_f_acu_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin_RUV_l_TEs@rownames),4)],
                            contrast_hec.cin_RUV_l_TEs$log2FoldChange)      
class_acu_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin_RUV_l_TEs@rownames),4)],
                            contrast_hec.cin_RUV_l_TEs$log2FoldChange)
...
sup_f_acu_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin2_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin2_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin2_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin2_RUV_l_TEs$log2FoldChange)      
class_acu_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin2_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin2_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin2_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin2_RUV_l_TEs$log2FoldChange)
...
sup_f_hec.cin_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin3_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin3_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin3_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin3_RUV_l_TEs$log2FoldChange)      
class_hec.cin_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin3_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin3_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin3_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin3_RUV_l_TEs$log2FoldChange)
...
sup_f_hec.cinWhec_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin4_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin4_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin4_RUV_l_TEs@rownames),4)],
                                  contrast_hec.cin4_RUV_l_TEs$log2FoldChange)      
class_hec.cinWhec_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin4_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin4_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin4_RUV_l_TEs@rownames),4)],
                                  contrast_hec.cin4_RUV_l_TEs$log2FoldChange)
...
contrast_hec.cin5_RUV_l_TEs <- subset(contrast_hec.cin5_RUV_l_TEs, !contrast_hec.cin5_RUV_l_TEs %in% hec.cin_cin_M_WTEs_l)
sup_f_hec.cin_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin5_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin5_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin5_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin5_RUV_l_TEs$log2FoldChange)      
class_hec.cin_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin5_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin5_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin5_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin5_RUV_l_TEs$log2FoldChange)
...
sup_f_hec.cinWhec_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin6_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin6_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin6_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin6_RUV_l_TEs$log2FoldChange)      
class_hec.cinWhec_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin6_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin6_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin6_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin6_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hec_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin7_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin7_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin7_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin7_RUV_l_TEs$log2FoldChange)      
class_acu.hec_hec_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin7_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin7_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin7_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin7_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hecWacu_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin8_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin8_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin8_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin8_RUV_l_TEs$log2FoldChange)      
class_acu.hecWacu_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin8_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin8_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin8_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin8_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hec_acu_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin9_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin9_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin9_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin9_RUV_l_TEs$log2FoldChange)      
class_acu.hec_acu_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin9_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin9_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin9_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin9_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hecWacu_acu_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin10_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin10_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin10_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin10_RUV_l_TEs$log2FoldChange)      
class_acu.hecWacu_acu_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin10_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin10_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin10_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin10_RUV_l_TEs$log2FoldChange)
...
sup_f_hec_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin11_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin11_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin11_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin11_RUV_l_TEs$log2FoldChange)      
class_hec_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin11_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin11_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin11_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin11_RUV_l_TEs$log2FoldChange)
...
sup_f_hec_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin12_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin12_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin12_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin12_RUV_l_TEs$log2FoldChange)      
class_hec_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin12_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin12_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin12_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin12_RUV_l_TEs$log2FoldChange)
...
sup_f_acu_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin13_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin13_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin13_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin13_RUV_l_TEs$log2FoldChange)      
class_acu_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin13_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin13_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin13_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin13_RUV_l_TEs$log2FoldChange)
...
sup_f_acu_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin14_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin14_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin14_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin14_RUV_l_TEs$log2FoldChange)      
class_acu_cin_M_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin14_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin14_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin14_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin14_RUV_l_TEs$log2FoldChange)
...
sup_f_hec.cinWcin_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin15_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin15_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin15_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin15_RUV_l_TEs$log2FoldChange)      
class_hec.cinWcin_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin15_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin15_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin15_RUV_l_TEs@rownames),4)],
                              contrast_hec.cin15_RUV_l_TEs$log2FoldChange)
...
sup_f_hec.cinWcin_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin16_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin16_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin16_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin16_RUV_l_TEs$log2FoldChange)      
class_hec.cinWcin_cin_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin16_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin16_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin16_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin16_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hecWhec_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin17_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin17_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin17_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin17_RUV_l_TEs$log2FoldChange)      
class_acu.hecWhec_hec_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin17_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin17_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin17_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin17_RUV_l_TEs$log2FoldChange)
...
sup_f_acu.hecWhec_acu_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin18_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin18_RUV_l_TEs@rownames)])[seq(3,4*length(contrast_hec.cin18_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin18_RUV_l_TEs$log2FoldChange)      
class_acu.hecWhec_acu_F_TEs_l<- cbind(unlist(strsplit(contrast_hec.cin18_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin18_RUV_l_TEs@rownames)])[seq(4,4*length(contrast_hec.cin18_RUV_l_TEs@rownames),4)],
                                      contrast_hec.cin18_RUV_l_TEs$log2FoldChange)
...
liver_plot<- ggplot(DETEs_l_melt, aes(x=factor(group, levels = level_order_l), y=value)) +
  ...
  facet_wrap(~sex_l,scale="free_x")+labs(fill="Regulation")+geom_hline(yintercept = 0)+ scale_y_continuous(limits = c(-200,650), breaks = seq(-200, 800, 200), labels = abs)+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
liver_plot_fams<- ggplot(fams_l_counts, aes(x=factor(contrast_l, levels = level_order_l), y=counts)) +
  ...
  #geom_bracket(xmin = 4, xmax = 11, label = "Hybrids", y.position = 180)+
  labs(fill="Superfamily")+geom_hline(yintercept = 0)+ scale_y_continuous(limits = c(-200,650), breaks = seq(-200, 800, 200), labels = abs)+
...
liver_plot_class<- ggplot(class_l_counts, aes(x=factor(contrast_l, levels = level_order_l), y=counts)) +
  ...
  #geom_bracket(xmin = 4, xmax = 11, label = "Hybrids", y.position = 180)+
  labs(fill="Order")+geom_hline(yintercept = 0)+ scale_y_continuous(limits = c(-200,650), breaks = seq(-200, 800, 200), labels = abs)+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+facet_wrap(~sex_l,scale="free_x")
...
ov_acu.hecW_m_up <- list("AxH(HW)H" = row.names(subset(acu.hec_hec_WTEs_o, acu.hec_hec_WTEs_o$log2FoldChange > 0)),
                        "AxH(HW)A"= row.names(subset(acu.hec_acu_WTEs_o, acu.hec_acu_WTEs_o$log2FoldChange > 0)),
                        "AxH(AW)H"=row.names(subset(acu.hecWacu_hec_WTEs_o, acu.hecWacu_hec_WTEs_o$log2FoldChange > 0)),
                        "AxH(AW)A"=row.names(subset(acu.hecWacu_acu_WTEs_o, acu.hecWacu_acu_WTEs_o$log2FoldChange > 0)))
o_venn_ah_up_w<- ggVennDiagram(ov_acu.hecW_m_up, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "blue")

ov_acu.hecW_m_dw <- list("AxH(HW)H" = row.names(subset(acu.hec_hec_WTEs_o, acu.hec_hec_WTEs_o$log2FoldChange < 0)),
                         "AxH(HW)A"= row.names(subset(acu.hec_acu_WTEs_o, acu.hec_acu_WTEs_o$log2FoldChange < 0)),
                         "AxH(AW)H"=row.names(subset(acu.hecWacu_hec_WTEs_o, acu.hecWacu_hec_WTEs_o$log2FoldChange < 0)),
                         "AxH(AW)A"=row.names(subset(acu.hecWacu_acu_WTEs_o, acu.hecWacu_acu_WTEs_o$log2FoldChange < 0)))
o_venn_ah_dw_w<- ggVennDiagram(ov_acu.hecW_m_dw,label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "red")
...
ov_hec.cinW_m_up <- list("HxC(HW)H" = row.names(subset(hec.cin_hec_WTEs_o, hec.cin_hec_WTEs_o$log2FoldChange > 0)),
                         "HxC(HW)C"= row.names(subset(hec.cin_cin_WTEs_o, hec.cin_cin_WTEs_o$log2FoldChange > 0)),
                         "HxC(CW)H"=row.names(subset(hec.cinWcin_hec_WTEs_o, hec.cinWcin_hec_WTEs_o$log2FoldChange > 0)),
                         "HxC(CW)C"=row.names(subset(hec.cinWcin_cin_WTEs_o, hec.cinWcin_cin_WTEs_o$log2FoldChange > 0)))
o_venn_hc_up_w<- ggVennDiagram(ov_hec.cinW_m_up, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "blue")

ov_hec.cinW_m_dw <- list("HxC(HW)H" = row.names(subset(hec.cin_hec_WTEs_o, hec.cin_hec_WTEs_o$log2FoldChange < 0)),
                         "HxC(HW)C"= row.names(subset(hec.cin_cin_WTEs_o, hec.cin_cin_WTEs_o$log2FoldChange < 0)),
                         "HxC(CW)H"=row.names(subset(hec.cinWcin_hec_WTEs_o, hec.cinWcin_hec_WTEs_o$log2FoldChange < 0)),
                         "HxC(CW)C"=row.names(subset(hec.cinWcin_cin_WTEs_o, hec.cinWcin_cin_WTEs_o$log2FoldChange < 0)))
o_venn_hc_dw_w<- ggVennDiagram(ov_hec.cinW_m_dw, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "red")
library(ggpubr)
...
o_venn_hc_all <- ggarrange(o_venn_hc_up,
                           o_venn_hc_up_w,
                           o_venn_hc_dw,
                           o_venn_hc_dw_w,
                           ncol = 2, nrow = 2, labels = c("A","B","C","D"))

ggsave("venn_ovaries_acu-hec.png",plot=o_venn_ah_all, dpi = 'retina', height = 8, width = 12)
ggsave("venn_ovaries_hec-cin.png",plot=o_venn_hc_all, dpi = 'retina', height = 8, width = 12)
...
ggsave("venn_testes_all.png",plot=t_venn_ah_all, dpi = 'retina', height = 8, width = 12)
...
ggsave("venn_liver_all_M.png",plot=l_venn_ah_all_M, dpi = 'retina', height = 8, width = 12)
...
l_acu.hecW_m_up_F <- list("AxH(HW)H" = row.names(subset(acu.hecWhec_hec_WTEs_l, acu.hecWhec_hec_WTEs_l$log2FoldChange > 0)),
                         "AxH(HW)A"= row.names(subset(acu.hecWhec_acu_WTEs_l, acu.hecWhec_acu_WTEs_l$log2FoldChange > 0)),
                         "AxH(AW)H"=row.names(subset(acu.hecWacu_hec_WTEs_l, acu.hecWacu_hec_WTEs_l$log2FoldChange > 0)),
                         "AxH(AW)A"=row.names(subset(acu.hecWacu_acu_WTEs_l, acu.hecWacu_acu_WTEs_l$log2FoldChange > 0)))
l_venn_ah_up_w<- ggVennDiagram(l_acu.hecW_m_up_F, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "blue")

l_acu.hecW_m_dw_F <- list("AxH(HW)H" = row.names(subset(acu.hecWhec_hec_WTEs_l, acu.hecWhec_hec_WTEs_l$log2FoldChange < 0)),
                         "AxH(HW)A"= row.names(subset(acu.hecWhec_acu_WTEs_l, acu.hecWhec_acu_WTEs_l$log2FoldChange < 0)),
                         "AxH(AW)H"=row.names(subset(acu.hecWacu_hec_WTEs_l, acu.hecWacu_hec_WTEs_l$log2FoldChange < 0)),
                         "AxH(AW)A"=row.names(subset(acu.hecWacu_acu_WTEs_l, acu.hecWacu_acu_WTEs_l$log2FoldChange < 0)))
l_venn_ah_dw_w<- ggVennDiagram(l_acu.hecW_m_dw_F,label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "red")
...
l_hec.cinW_m_up_F <- list("HxC(HW)H" = row.names(subset(hec.cinWhec_hec_WTEs_l, hec.cinWhec_hec_WTEs_l$log2FoldChange > 0)),
                         "HxC(HW)C"= row.names(subset(hec.cinWhec_cin_WTEs_l, hec.cinWhec_cin_WTEs_l$log2FoldChange > 0)),
                         "HxC(CW)H"=row.names(subset(hec.cinWcin_hec_WTEs_l, hec.cinWcin_hec_WTEs_l$log2FoldChange > 0)),
                         "HxC(CW)C"=row.names(subset(hec.cinWcin_cin_WTEs_l, hec.cinWcin_cin_WTEs_l$log2FoldChange > 0)))
l_venn_hc_up_w<- ggVennDiagram(l_hec.cinW_m_up_F, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "blue")

l_hec.cinW_m_dw_F <- list("HxC(HW)H" = row.names(subset(hec.cinWhec_hec_WTEs_l, hec.cinWhec_hec_WTEs_l$log2FoldChange < 0)),
                          "HxC(HW)C"= row.names(subset(hec.cinWhec_cin_WTEs_l, hec.cinWhec_cin_WTEs_l$log2FoldChange < 0)),
                          "HxC(CW)H"=row.names(subset(hec.cinWcin_hec_WTEs_l, hec.cinWcin_hec_WTEs_l$log2FoldChange < 0)),
                          "HxC(CW)C"=row.names(subset(hec.cinWcin_cin_WTEs_l, hec.cinWcin_cin_WTEs_l$log2FoldChange < 0)))
l_venn_hc_dw_w<- ggVennDiagram(l_hec.cinW_m_dw_F, label_alpha = 0.4, set_size = 2.5)+ggplot2::scale_fill_gradient(low="white",high = "red")
library(ggpubr)

l_venn_ah_all_F <- ggarrange(l_venn_ah_up_F,l_venn_ah_up_w,l_venn_ah_dw_F,l_venn_ah_dw_w,
                           ncol = 2, nrow = 2, labels = c("A","B","C","D"))
l_venn_hc_all_F <- ggarrange(l_venn_hc_up_F,l_venn_hc_up_w,l_venn_hc_dw_F,l_venn_hc_dw_w,
                           ncol = 2, nrow = 2, labels = c("A","B","C","D"))

ggsave("venn_liver_acu-hec_F.png",plot=l_venn_ah_all_F, dpi = 'retina', height = 8, width = 12)
ggsave("venn_liver_hec-cin_F.png",plot=l_venn_hc_all_F, dpi = 'retina', height = 8, width = 12)
...
ggsave("liver_fig.png",plot=liver_fig, dpi = 'retina', height = 8, width = 12)
...
### Permutation test ####
genes_gtf <- read.table('LTFr_annotation_braker3.gtf', header = FALSE, sep = '\t')
genes_gtf <- subset(genes_gtf, str_detect(genes_gtf$V9, "gene_id"))
TEs_gtf<- read.table('PoHecki.filtered_TE.gtf.gz', header = FALSE, sep = '\t')
TEs_gtf <- subset(TEs_gtf, str_detect(TEs_gtf$V1, "chr"))
Z_chrTEs <- subset(TEs_gtf, TEs_gtf$V1 == "chrZ_H1")

o_Z1<- subset(contrast_hec.cin3_RUV_o_TEs, unlist(strsplit(contrast_hec.cin3_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin3_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin3_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z2<- subset(contrast_hec.cin4_RUV_o_TEs, unlist(strsplit(contrast_hec.cin4_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin4_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin4_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z3<- subset(contrast_hec.cin5_RUV_o_TEs, unlist(strsplit(contrast_hec.cin5_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin5_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin5_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z4<- subset(contrast_hec.cin6_RUV_o_TEs, unlist(strsplit(contrast_hec.cin6_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin6_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin6_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z5<- subset(contrast_hec.cin8_RUV_o_TEs, unlist(strsplit(contrast_hec.cin8_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin8_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin8_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z6<- subset(contrast_hec.cin9_RUV_o_TEs, unlist(strsplit(contrast_hec.cin9_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin9_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin9_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z7<- subset(contrast_hec.cin10_RUV_o_TEs, unlist(strsplit(contrast_hec.cin10_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin10_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin10_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
o_Z8<- subset(contrast_hec.cin11_RUV_o_TEs, unlist(strsplit(contrast_hec.cin11_RUV_o_TEs@rownames, ":")[1:length(contrast_hec.cin11_RUV_o_TEs@rownames)])[seq(1,4*length(contrast_hec.cin11_RUV_o_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
mean_Z_o<- mean(dim(o_Z8)[1],dim(o_Z7)[1],dim(o_Z6)[1],dim(o_Z5)[1],dim(o_Z4)[1],dim(o_Z3)[1],dim(o_Z2)[1],dim(o_Z1)[1])
mean_W_o <- mean(up_o_w[4:11])
mean_soma_o <- mean((up_o[4]-up_o_w[4]-dim(o_Z4)[1]),(up_o[5]-up_o_w[5]-dim(o_Z3)[1]),(up_o[6]-up_o_w[6]-dim(o_Z8)[1]),
                    (up_o[7]-up_o_w[7]-dim(o_Z7)[1]),(up_o[8]-up_o_w[8]-dim(o_Z2)[1]),(up_o[9]-up_o_w[9]-dim(o_Z1)[1]),
                    (up_o[10]-up_o_w[10]-dim(o_Z6)[1]),(up_o[11]-up_o_w[11]-dim(o_Z5)[1]))
mean_total <- mean_soma_o + mean_W_o + mean_Z_o

mean_Z_o_acu.hec<- mean(dim(o_Z8)[1],dim(o_Z7)[1],dim(o_Z4)[1],dim(o_Z3)[1])
mean_Z_o_hec.cin<- mean(dim(o_Z6)[1],dim(o_Z5)[1],dim(o_Z2)[1],dim(o_Z1)[1])
mean_W_o_acu.hec <- mean(up_o_w[4:7])
mean_W_o_hec.cin <- mean(up_o_w[8:11])
mean_soma_o_acu.hec <- mean((up_o[4]-up_o_w[4]-dim(o_Z4)[1]),(up_o[5]-up_o_w[5]-dim(o_Z3)[1]),(up_o[6]-up_o_w[6]-dim(o_Z8)[1]),
                    (up_o[7]-up_o_w[7]-dim(o_Z7)[1]))
mean_soma_o_.hec.cin <- mean((up_o[8]-up_o_w[8]-dim(o_Z2)[1]),(up_o[9]-up_o_w[9]-dim(o_Z1)[1]),
(up_o[10]-up_o_w[10]-dim(o_Z6)[1]),(up_o[11]-up_o_w[11]-dim(o_Z5)[1]))
mean_total <- mean_soma_o + mean_W_o + mean_Z_o
mean_total_acu.hec <- mean_soma_o_acu.hec + mean_W_o_acu.hec + mean_Z_o_acu.hec
mean_total_hec.cin <- mean_soma_o_.hec.cin + mean_W_o_hec.cin + mean_Z_o_hec.cin

w_copies <- sum(TEs_gtf$V1 == "chrW_H1")
z_copies <- sum(TEs_gtf$V1 == "chrZ_H1")
somatic_copies <- sum(TEs_gtf$V1 != "chrW_H1" & TEs_gtf$V1 != "chrZ_H1")
total_copies <- w_copies + z_copies + somatic_copies

exp_acu.hec_total <- mean_total_acu.hec/total_copies
exp_acu.hec_Z <- mean_Z_o_acu.hec/z_copies
exp_acu.hec_W <- mean_W_o_acu.hec/w_copies
exp_acu.hec_somatic <- mean_soma_o_acu.hec/somatic_copies

exp_hec.cin_total <- mean_total_hec.cin/total_copies
exp_hec.cin_Z <- exp_acu.hec_total*z_copies
exp_acu.hec_W <- exp_acu.hec_total*w_copies
exp_acu.hec_somatic <- exp_acu.hec_total*somatic_copies

chr_cat <- c("somatic","W","Z")
obs_DETEs_o_acu.hec <- c(mean_soma_o_acu.hec, mean_W_o_acu.hec, mean_Z_o_acu.hec)
n_DETEs_o_acu.hec <- round(sum(obs_DETEs_o_acu.hec))
obs_DETEs_o_hec.cin <- c(mean_soma_o_.hec.cin, mean_W_o_hec.cin, mean_Z_o_hec.cin)
n_DETEs_o_hec.cin <- round(sum(obs_DETEs_o_hec.cin))
total_copies_n <- c((2*somatic_copies), w_copies, z_copies)
obs_acu.hec_d <- rep(chr_cat,total_copies_n)  
set.seed(42)
perms <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d, n_DETEs_o_acu.hec)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms <- rbind(perms, report)
}
...
perms_melted <- melt(perms)

p_value_o_acu.hec_soma <- mean(perms$soma >= mean_soma_o_acu.hec)
p_value_o_acu.hec_W <- mean(perms$w >= mean_W_o_acu.hec)
p_value_o_acu.hec_Z <- mean(perms$z >= mean_Z_o_acu.hec)

perms_hec.cin <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d, n_DETEs_o_hec.cin)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_hec.cin <- rbind(perms_hec.cin, report)
}

p_value_o_hec.cin_soma <- mean(perms_hec.cin$soma >= mean_soma_o_.hec.cin)
p_value_o_hec.cin_W <- mean(perms_hec.cin$w >= mean_W_o_hec.cin)
p_value_o_hec.cin_Z <- mean(perms_hec.cin$z >= mean_Z_o_hec.cin)

o_acu.hec_soma_p<- ggplot(perms, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_o_acu.hec), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec autosomes")+theme_bw()
o_acu.hec_W_p<-ggplot(perms, aes(x=w))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_W_o_acu.hec), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec W chromosome")+theme_bw()+annotate("text", x=15, y=1250, label = "*")
o_acu.hec_Z_p<-ggplot(perms, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_o_acu.hec), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec Z chromosome")+theme_bw()+annotate("text", x=17, y=1350, label = "***")

o_hec.cin_soma_p<-ggplot(perms_hec.cin, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_o_.hec.cin), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin autosomes")+theme_bw()
o_hec.cin_W_p<-ggplot(perms_hec.cin, aes(x=w))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_W_o_hec.cin), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin W chromosome")+theme_bw()+annotate("text", x=55, y=920, label = "****")
o_hec.cin_Z_p<-ggplot(perms_hec.cin, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_o_hec.cin), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin Z chromosome")+theme_bw()+annotate("text", x=28, y=920, label = "***")

### Testes ####
t_Z1<- subset(contrast_hec.cin3_RUV_t_TEs, unlist(strsplit(contrast_hec.cin3_RUV_t_TEs@rownames, ":")[1:length(contrast_hec.cin3_RUV_t_TEs@rownames)])[seq(1,4*length(contrast_hec.cin3_RUV_t_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
t_Z2<- subset(contrast_hec.cin4_RUV_t_TEs, unlist(strsplit(contrast_hec.cin4_RUV_t_TEs@rownames, ":")[1:length(contrast_hec.cin4_RUV_t_TEs@rownames)])[seq(1,4*length(contrast_hec.cin4_RUV_t_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
t_Z3<- subset(contrast_hec.cin5_RUV_t_TEs, unlist(strsplit(contrast_hec.cin5_RUV_t_TEs@rownames, ":")[1:length(contrast_hec.cin5_RUV_t_TEs@rownames)])[seq(1,4*length(contrast_hec.cin5_RUV_t_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
t_Z4<- subset(contrast_hec.cin6_RUV_t_TEs, unlist(strsplit(contrast_hec.cin6_RUV_t_TEs@rownames, ":")[1:length(contrast_hec.cin6_RUV_t_TEs@rownames)])[seq(1,4*length(contrast_hec.cin6_RUV_t_TEs@rownames),4)] %in% Z_chrTEs$TE_id)

mean_Z_t_acu.hec<- mean(dim(t_Z3)[1],dim(t_Z4)[1])
mean_Z_t_hec.cin<- mean(dim(t_Z1)[1],dim(t_Z2)[1])
mean_soma_t_acu.hec <- mean((up_t[4]-dim(t_Z4)[1]),(up_t[5]-dim(t_Z3)[1]))
mean_soma_t_hec.cin <- mean((up_t[6]-dim(t_Z2)[1]),(up_t[7]-dim(t_Z1)[1]))
mean_total_acu.hec <- mean_soma_t_acu.hec + mean_Z_t_acu.hec
mean_total_hec.cin <- mean_soma_t_hec.cin + mean_Z_t_hec.cin

obs_DETEs_t_acu.hec <- c(mean_soma_t_acu.hec, mean_Z_t_acu.hec)
n_DETEs_t_acu.hec <- round(sum(obs_DETEs_t_acu.hec))
obs_DETEs_t_hec.cin <- c(mean_soma_t_hec.cin, mean_Z_t_hec.cin)
n_DETEs_t_hec.cin <- round(sum(obs_DETEs_t_hec.cin))

chr_cat_t <- c("somatic","Z")
total_copies_n_t <- c((2*somatic_copies), 2*z_copies)
obs_acu.hec_d_t <- rep(chr_cat_t,total_copies_n_t)  
perms_t_acu.hec <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_t, n_DETEs_t_acu.hec)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_t_acu.hec <- rbind(perms_t_acu.hec, report)
}

hist(perms_t_acu.hec$soma)
hist(perms_t_acu.hec$z)


p_value_t_acu.hec_soma <- mean(perms_t_acu.hec$soma >= mean_soma_t_acu.hec)
p_value_t_acu.hec_Z <- mean(perms$z >= mean_Z_t_acu.hec)

perms_t_hec.cin <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_t, n_DETEs_t_hec.cin)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_t_hec.cin <- rbind(perms_t_hec.cin, report)
}

p_value_t_hec.cin_soma <- mean(perms_t_hec.cin$soma >= mean_soma_t_hec.cin)
p_value_t_hec.cin_Z <- mean(perms_t_hec.cin$z >= mean_Z_t_hec.cin)

t_acu.hec_soma_p<-ggplot(perms_t_acu.hec, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_t_acu.hec), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec autosomes")+theme_bw()
t_acu.hec_Z_p<-ggplot(perms_t_acu.hec, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_t_acu.hec), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec Z chromosome")+theme_bw()+annotate("text", x=100, y=585, label = "****")

t_hec.cin_soma_p<-ggplot(perms_t_hec.cin, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_t_hec.cin), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin autosomes")+theme_bw()
t_hec.cin_Z_p<-ggplot(perms_t_hec.cin, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_t_hec.cin), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin Z chromosome")+theme_bw()+annotate("text", x=75, y=750, label = "****")

#### Liver #####
l_Z1<- subset(contrast_hec.cin7_RUV_l_TEs, unlist(strsplit(contrast_hec.cin7_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin7_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin7_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z2<- subset(contrast_hec.cin9_RUV_l_TEs, unlist(strsplit(contrast_hec.cin9_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin9_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin9_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z3<- subset(contrast_hec.cin3_RUV_l_TEs, unlist(strsplit(contrast_hec.cin3_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin3_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin3_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z4<- subset(contrast_hec.cin5_RUV_l_TEs, unlist(strsplit(contrast_hec.cin5_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin5_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin5_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z5<- subset(contrast_hec.cin17_RUV_l_TEs, unlist(strsplit(contrast_hec.cin17_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin17_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin17_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z6<- subset(contrast_hec.cin18_RUV_l_TEs, unlist(strsplit(contrast_hec.cin18_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin18_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin18_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z7<- subset(contrast_hec.cin8_RUV_l_TEs, unlist(strsplit(contrast_hec.cin8_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin8_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin8_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z8<- subset(contrast_hec.cin10_RUV_l_TEs, unlist(strsplit(contrast_hec.cin10_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin10_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin10_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z9<- subset(contrast_hec.cin4_RUV_l_TEs, unlist(strsplit(contrast_hec.cin4_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin4_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin4_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z10<- subset(contrast_hec.cin6_RUV_l_TEs, unlist(strsplit(contrast_hec.cin6_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin6_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin6_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z11<- subset(contrast_hec.cin15_RUV_l_TEs, unlist(strsplit(contrast_hec.cin15_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin15_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin15_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)
l_Z12<- subset(contrast_hec.cin16_RUV_l_TEs, unlist(strsplit(contrast_hec.cin16_RUV_l_TEs@rownames, ":")[1:length(contrast_hec.cin16_RUV_l_TEs@rownames)])[seq(1,4*length(contrast_hec.cin16_RUV_l_TEs@rownames),4)] %in% Z_chrTEs$TE_id)

mean_Z_l_acu.hec_M<- mean(dim(l_Z1)[1],dim(l_Z2)[1])

mean_Z_l_acu.hec_F<- mean(dim(l_Z5)[1],dim(l_Z6)[1],
                        dim(l_Z7)[1],dim(l_Z8)[1])

mean_Z_l_hec.cin_M<- mean(dim(l_Z3)[1],dim(l_Z4)[1])
mean_Z_l_hec.cin_F<- mean(dim(l_Z9)[1],dim(l_Z10)[1],dim(l_Z11)[1],dim(l_Z12)[1])
mean_soma_l_acu.hec_M <- mean((up_l[9]-dim(l_Z1)[1]),(up_l[12]-dim(l_Z2)[1]))
mean_soma_l_acu.hec_F <- mean((up_l[7]-up_l_W[4]-dim(l_Z5)[1]),(up_l[8]-up_l_W[5]-dim(l_Z6)[1]),
                              (up_l[10]-up_l_W[6]-dim(l_Z7)[1]),(up_l[11]-up_l_W[7]-dim(l_Z8)[1]))
mean_soma_l_hec.cin_M <- mean((up_l[15]-dim(l_Z4)[1]),(up_l[18]-dim(l_Z3)[1]))
mean_soma_l_hec.cin_F <- mean((up_l[13]-up_l_W[8]-dim(l_Z10)[1]),(up_l[14]-up_l_W[9]-dim(l_Z12)[1]),
                              (up_l[16]-up_l_W[10]-dim(l_Z9)[1]),(up_l[17]-up_l_W[11]-dim(l_Z11)[1]))

mean_W_l_acu.hec_F<- mean(up_l_W[4:7])
mean_W_l_hec.cin_F<- mean(up_l_W[8:11])

mean_total_acu.hec_l_M <- mean_soma_l_acu.hec_M + mean_Z_l_acu.hec_M
mean_total_acu.hec_l_F <- mean_soma_l_acu.hec_F + mean_Z_l_acu.hec_F + mean_W_l_acu.hec_F
mean_total_hec.cin_l_M <- mean_soma_l_hec.cin_M + mean_Z_l_hec.cin_M
mean_total_hec.cin_l_F <- mean_soma_l_hec.cin_F + mean_Z_l_hec.cin_F + mean_W_l_hec.cin_F

obs_DETEs_l_acu.hec_M <- c(mean_soma_l_acu.hec_M, mean_Z_l_acu.hec_M)
n_DETEs_l_acu.hec_M <- round(sum(obs_DETEs_l_acu.hec_M))
obs_DETEs_l_acu.hec_F <- c(mean_soma_l_acu.hec_F, mean_Z_l_acu.hec_F, mean_W_l_acu.hec_F)
n_DETEs_l_acu.hec_F <- round(sum(obs_DETEs_l_acu.hec_F))

obs_DETEs_l_hec.cin_M <- c(mean_soma_l_hec.cin_M, mean_Z_l_hec.cin_M)
n_DETEs_l_hec.cin_M <- round(sum(obs_DETEs_l_hec.cin_M))
obs_DETEs_l_hec.cin_F <- c(mean_soma_l_hec.cin_F, mean_Z_l_hec.cin_F, mean_W_l_hec.cin_F)
n_DETEs_l_hec.cin_F <- round(sum(obs_DETEs_l_hec.cin_F))

chr_cat_l_M <- c("somatic","Z")
total_copies_n_l_M <- c((2*somatic_copies), 2*z_copies)
obs_acu.hec_d_l_M <- rep(chr_cat_t,total_copies_n_t)  
perms_l_acu.hec_M <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_l_M, n_DETEs_l_acu.hec_M)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_l_acu.hec_M <- rbind(perms_l_acu.hec_M, report)
}

hist(perms_l_acu.hec_M$soma)
hist(perms_l_acu.hec_M$z)


p_value_l_acu.hec_soma_M <- mean(perms_l_acu.hec_M$soma >= mean_soma_l_acu.hec_M)
p_value_l_acu.hec_Z_M <- mean(perms_l_acu.hec_M$z >= mean_Z_l_acu.hec_M)

perms_l_hec.cin_M <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_l_M, n_DETEs_l_hec.cin_M)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_l_hec.cin_M <- rbind(perms_l_hec.cin_M, report)
}

p_value_l_hec.cin_soma_M <- mean(perms_l_hec.cin_M$soma >= mean_soma_l_hec.cin_M)
p_value_l_hec.cin_Z_M <- mean(perms_l_hec.cin_M$z >= mean_Z_l_hec.cin_M)

l_acu.hec_M_soma_p<-ggplot(perms_l_acu.hec_M, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_l_acu.hec_M), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec autosomes")+theme_bw()
l_acu.hec_M_Z_p<-ggplot(perms_l_acu.hec_M, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_l_acu.hec_M), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec Z chromosome")+theme_bw()+annotate("text", x=10, y=1585, label = "***")

l_hec.cin_M_soma_p<-ggplot(perms_l_hec.cin_M, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_l_hec.cin_M), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin autosomes")+theme_bw()
l_hec.cin_M_Z_p<-ggplot(perms_l_hec.cin_M, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_l_hec.cin_M), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin Z chromosome")+theme_bw()+annotate("text", x=32, y=800, label = "***")


chr_cat_l_F <- c("somatic","Z","W")
total_copies_n_l_F <- c((2*somatic_copies), z_copies, w_copies)
obs_acu.hec_d_l_F <- rep(chr_cat_l_F,total_copies_n_l_F)  
perms_l_acu.hec_F <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_l_F, n_DETEs_l_acu.hec_F)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_l_acu.hec_F <- rbind(perms_l_acu.hec_F, report)
}

hist(perms_l_acu.hec_F$soma)
hist(perms_l_acu.hec_F$z)
hist(perms_l_acu.hec_F$w)


p_value_l_acu.hec_soma_F <- mean(perms_l_acu.hec_F$soma >= mean_soma_l_acu.hec_F)
p_value_l_acu.hec_Z_F <- mean(perms_l_acu.hec_F$z >= mean_Z_l_acu.hec_F)
p_value_l_acu.hec_W_F <- mean(perms_l_acu.hec_F$w >= mean_W_l_acu.hec_F)

perms_l_hec.cin_F <- c()
for (n in 1:10000) {
  DETs <- sample(obs_acu.hec_d_l_F, n_DETEs_l_hec.cin_F)
  soma<- sum(DETs=="somatic")
  w <- sum(DETs=="W")
  z<- sum(DETs=="Z")
  report <- data.frame(soma,w,z)
  perms_l_hec.cin_F <- rbind(perms_l_hec.cin_F, report)
}

p_value_l_hec.cin_soma_F <- mean(perms_l_hec.cin_F$soma >= mean_soma_l_hec.cin_F)
p_value_l_hec.cin_Z_F <- mean(perms_l_hec.cin_F$z >= mean_Z_l_hec.cin_F)
p_value_l_hec.cin_W_F <- mean(perms_l_hec.cin_F$w >= mean_W_l_hec.cin_F)

l_acu.hec_F_soma_p<-ggplot(perms_l_acu.hec_F, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_l_acu.hec_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec autosomes")+theme_bw()
l_acu.hec_F_Z_p<-ggplot(perms_l_acu.hec_F, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_l_acu.hec_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec Z chromosome")+theme_bw()+annotate("text", x=9, y=2300, label = "****")
l_acu.hec_F_W_p<-ggplot(perms_l_acu.hec_F, aes(x=w))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_W_l_acu.hec_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("acu-hec W chromosome")+theme_bw()+annotate("text", x=7, y=2100, label = "****")

l_hec.cin_F_soma_p<-ggplot(perms_l_hec.cin_F, aes(x=soma))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_soma_l_hec.cin_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin autosomes")+theme_bw()
l_hec.cin_F_Z_p<-ggplot(perms_l_hec.cin_F, aes(x=z))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_Z_l_hec.cin_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin Z chromosome")+theme_bw()+annotate("text", x=38, y=750, label = "****")
l_hec.cin_F_W_p<-ggplot(perms_l_hec.cin_F, aes(x=w))+geom_histogram(binwidth = 1, fill="lightgrey", color="black")+geom_vline(aes(xintercept= mean_W_l_hec.cin_F), color = "red")+
  xlab("Expected DETEs")+ylab("Frequency")+ggtitle("hec-cin W chromosome")+theme_bw()+annotate("text", x=40, y=750, label = "**")

ovaries_perms <- ggarrange(o_acu.hec_soma_p, o_hec.cin_soma_p, o_acu.hec_Z_p, o_hec.cin_Z_p,
                           o_acu.hec_W_p, o_hec.cin_W_p, ncol = 2, nrow = 3, labels = "AUTO")

testes_perms <- ggarrange(t_acu.hec_soma_p, t_hec.cin_soma_p, t_acu.hec_Z_p, t_hec.cin_Z_p,
                           ncol = 2, nrow = 2, labels = "AUTO")

liver_perms_M <- ggarrange(l_acu.hec_M_soma_p, l_hec.cin_M_soma_p, l_acu.hec_M_Z_p, l_hec.cin_M_Z_p,
                          ncol = 2, nrow = 2, labels = "AUTO")

liver_perms_F <- ggarrange(l_acu.hec_F_soma_p, l_hec.cin_F_soma_p, l_acu.hec_F_Z_p, l_hec.cin_F_Z_p,
                           l_acu.hec_F_W_p, l_hec.cin_F_W_p, ncol = 2, nrow = 3, labels = "AUTO")

ggsave("ovaries_perms.png",plot=ovaries_perms, dpi = 'retina', height = 12, width = 10)
ggsave("testes_perms.png",plot=testes_perms, dpi = 'retina', height = 8, width = 10)
ggsave("liver_M_perms.png",plot=liver_perms_M, dpi = 'retina', height = 8, width = 10)
ggsave("liver_F_perms.png",plot=liver_perms_F, dpi = 'retina', height = 12, width = 10)
...
ggsave("boxplot_fig.png",plot=box_fig, dpi = 'retina', height = 10, width = 10)

### Chromosome type plot DETE densities #####
dens_o <- as.data.table(list(Autosome=c(up_o[4],up_o[5],up_o[6],up_o[7],up_o[8],up_o[9],up_o[10],up_o[11]),
            W=c(up_o_w[4],up_o_w[5],up_o_w[6],up_o_w[7],up_o_w[8],up_o_w[9],up_o_w[10],up_o_w[11]),
           Z=c(dim(o_Z4)[1],dim(o_Z3)[1],dim(o_Z8)[1],dim(o_Z7)[1],dim(o_Z2)[1],dim(o_Z1)[1],
           dim(o_Z6)[1],dim(o_Z5)[1])))
row.names(dens_o)<-row.names(up_o)[4:11]
dens_o$cont <- NA
dens_o$cont[1:4] <- "acu-hec"
dens_o$cont[5:8] <- "hec-cin"
dens_o$Autosome <- dens_o$Autosome/total_copies_n[1]
dens_o$W <- dens_o$W/total_copies_n[2]
dens_o$Z <- dens_o$Z/total_copies_n[3]
dens_o_melt <- melt(dens_o)

dens_o_p<- ggplot(dens_o_melt, aes(x=variable, y=value))+geom_boxplot(aes(color=cont))+
  geom_pwc(
    method = "t_test", label = "p.signif",
    bracket.nudge.y = 4.1, step.increase = 0.49
  )+scale_y_continuous(limits = c(0,0.025), breaks = seq(0, 0.02, 0.005))+
  geom_point(aes(color=cont),position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6, jitter.height = 0), alpha = 0.5)+
  labs(color="Contrast")+xlab("Chromosome")+ylab("DETEs per copy")+ggtitle("Ovaries")+facet_wrap(~cont)+theme_bw()


dens_t <- as.data.table(list(Autosome=c(up_t[4],up_t[5],up_t[6],up_t[7]),
                                        Z=c(dim(t_Z4)[1],dim(t_Z3)[1],dim(t_Z1)[1],dim(t_Z2)[1])))
row.names(dens_t)<-row.names(up_t)[4:7]
dens_t$cont <- NA
dens_t$cont[1:2] <- "acu-hec"
dens_t$cont[3:4] <- "hec-cin"
dens_t$Autosome <- dens_t$Autosome/total_copies_n[1]
dens_t$Z <- dens_t$Z/total_copies_n[3]*2
dens_t_melt <- melt(dens_t)

dens_t_p<-ggplot(dens_t_melt, aes(x=variable, y=value))+geom_boxplot(aes(color=cont))+
  geom_pwc(
    method = "t_test", label = "p.signif",
    bracket.nudge.y = 0.2
  )+scale_y_continuous(limits = c(0,0.025), breaks = seq(0, 0.02, 0.005))+
  geom_point(aes(color=cont),position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6, jitter.height = 0), alpha = 0.5)+
  labs(color="Contrast")+xlab("Chromosome")+ylab("DETEs per copy")+ggtitle("Testes")+theme_bw()+facet_wrap(~cont)

dens_l_M <- as.data.table(list(Autosome=c(up_l[9],up_l[12],up_l[15],up_l[18]),
                             Z=c(dim(l_Z1)[1],dim(l_Z2)[1],dim(l_Z3)[1],dim(l_Z4)[1])))
row.names(dens_l_M)<-row.names(up_l)[c(9,12,15,18)]
dens_l_M$cont <- NA
dens_l_M$cont[1:2] <- "acu-hec"
dens_l_M$cont[3:4] <- "hec-cin"
dens_l_M$Autosome <- dens_l_M$Autosome/total_copies_n[1]
dens_l_M$Z <- dens_l_M$Z/total_copies_n[3]*2
dens_l_M_melt <- melt(dens_l_M)

dens_l_M_p<-ggplot(dens_l_M_melt, aes(x=variable, y=value))+geom_boxplot(aes(color=cont))+
  geom_pwc(
    method = "t_test", label = "p.signif",
    bracket.nudge.y = 4.2
  )+scale_y_continuous(limits = c(0,0.025), breaks = seq(0, 0.02, 0.005))+
  geom_point(aes(color=cont),position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6, jitter.height = 0), alpha = 0.5)+
  labs(color="Contrast")+xlab("Chromosome")+ylab("DETEs per copy")+ggtitle("Liver male")+facet_wrap(~cont) +theme_bw()

dens_l_F <- as.data.table(list(Autosome=c(up_l[7],up_l[8],up_l[10],up_l[11],up_l[13],up_l[14],up_l[16],up_l[17]),
                             W=c(up_l_W[4],up_l_W[5],up_l_W[6],up_l_W[7],up_l_W[8],up_l_W[9],up_l_W[10],up_l_W[11]),
                             Z=c(dim(l_Z5)[1],dim(l_Z6)[1],
                                 dim(l_Z7)[1],dim(l_Z8)[1],dim(l_Z9)[1],dim(l_Z10)[1],dim(l_Z11)[1],dim(l_Z12)[1])))
row.names(dens_l_F)<-row.names(up_l_W)[4:11]
dens_l_F$cont <- NA
dens_l_F$cont[1:4] <- "acu-hec"
dens_l_F$cont[5:8] <- "hec-cin"
dens_l_F$Autosome <- dens_l_F$Autosome/total_copies_n[1]
dens_l_F$W <- dens_l_F$W/total_copies_n[2]
dens_l_F$Z <- dens_l_F$Z/total_copies_n[3]
dens_l_F_melt <- melt(dens_l_F)

dens_l_F_p<-ggplot(dens_l_F_melt, aes(x=variable, y=value))+geom_boxplot(aes(color=cont))+
  geom_pwc(
    method = "t_test", label = "p.signif",
    bracket.nudge.y = 6.2, step.increase = 0.7
  )+scale_y_continuous(limits = c(0,0.025), breaks = seq(0, 0.02, 0.005))+
  geom_point(aes(color=cont),position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6, jitter.height = 0), alpha = 0.5)+
  labs(color="Contrast")+xlab("Chromosome")+ylab("DETEs per copy")+ggtitle("Liver female")+facet_wrap(~cont)+theme_bw()

dens_fig <- ggarrange(dens_o_p,dens_t_p,dens_l_M_p,dens_l_F_p, nrow = 2, ncol = 2, labels = "AUTO")
ggsave("dens_fig.png",plot=dens_fig, dpi = 'retina', height = 10, width = 12)

### Proximity plots ####
genes_gtf <- read.table("LTFr_annotation_braker3.gtf", fill = T)
genes_gtf <- genes_gtf %>% group_by(V13) %>% summarise(chr=first(V1), start = first(V4), end= max(V5))
genes_gtf <- subset(genes_gtf, str_detect(genes_gtf$chr, "chr"))
colnames(genes_gtf)[1]<- "gene_id"
TEs_gtf <- read.table("PoHecki.filtered_TE.gtf.gz", fill = T)
TEs_gtf <- TEs_gtf %>% group_by(V13) %>% summarise(chr=first(V1), start = first(V4), end= max(V5))
TEs_gtf <- subset(TEs_gtf, str_detect(TEs_gtf$chr, "chr"))
colnames(TEs_gtf)[1]<- "TE_id"

### Ovaries ####
ov_acu.hec_g_up <- list(row.names(subset(contrast_hec.cin5_RUV_o, contrast_hec.cin5_RUV_o$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin5_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin6_RUV_o, contrast_hec.cin6_RUV_o$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin6_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin10_RUV_o, contrast_hec.cin10_RUV_o$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin10_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin11_RUV_o, contrast_hec.cin11_RUV_o$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin11_RUV_o),"g"))))
ov_acu.hec_g_up <- unique(unlist(ov_acu.hec_g_up))
ov_acu.hec_m_up_unique <-unlist(str_split(unlist(ov_acu.hec_m_up),":")[1:length(unlist(ov_acu.hec_m_up))])[seq(1,length(unlist(ov_acu.hec_m_up)),4)] 

ov_acu.hec_m_up_unique <- subset(ov_acu.hec_m_up_unique,ov_acu.hec_m_up_unique %in% TEs_gtf$TE_id)

prox_genes <- c()
for (i in ov_acu.hec_m_up_unique) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes <- rbind(prox_genes, gene_chr)
}

prox_genes<- subset(prox_genes, prox_genes$gene_id %in% unlist(ov_acu.hec_g_up))
hist(prox_genes$start)
ggplot(prox_genes, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

ov_hec.cin_g_up <- list(row.names(subset(contrast_hec.cin3_RUV_o, contrast_hec.cin3_RUV_o$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin3_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin4_RUV_o, contrast_hec.cin4_RUV_o$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin4_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin8_RUV_o, contrast_hec.cin8_RUV_o$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin8_RUV_o),"g"))),
                        row.names(subset(contrast_hec.cin9_RUV_o, contrast_hec.cin9_RUV_o$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin9_RUV_o),"g"))))
ov_hec.cin_g_up <- unique(unlist(ov_hec.cin_g_up))
ov_hec.cin_m_up_unique <-unlist(str_split(unlist(ov_hec.cin_m_up),":")[1:length(unlist(ov_hec.cin_m_up))])[seq(1,length(unlist(ov_hec.cin_m_up)),4)] 

ov_hec.cin_m_up_unique <- subset(ov_hec.cin_m_up_unique,ov_hec.cin_m_up_unique %in% TEs_gtf$TE_id)

prox_genes_hec.cin <- c()
for (i in ov_hec.cin_m_up_unique) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_hec.cin <- rbind(prox_genes_hec.cin, gene_chr)
}

prox_genes_hec.cin<- subset(prox_genes_hec.cin, prox_genes_hec.cin$gene_id %in% unlist(ov_hec.cin_g_up))
hist(prox_genes_hec.cin$start)
ggplot(prox_genes_hec.cin, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

### Testes #####
t_acu.hec_g_up <- list(row.names(subset(contrast_hec.cin5_RUV_t, contrast_hec.cin5_RUV_t$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin5_RUV_t),"g"))),
                        row.names(subset(contrast_hec.cin6_RUV_t, contrast_hec.cin6_RUV_t$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin6_RUV_t),"g"))))
t_acu.hec_g_up <- unique(unlist(t_acu.hec_g_up))
t_acu.hec_m_up_unique <-unlist(str_split(unlist(t_acu.hec_m_up),":")[1:length(unlist(t_acu.hec_m_up))])[seq(1,length(unlist(t_acu.hec_m_up)),4)] 

t_acu.hec_m_up_unique <- subset(t_acu.hec_m_up_unique,t_acu.hec_m_up_unique %in% TEs_gtf$TE_id)

prox_genes_t <- c()
for (i in t_acu.hec_m_up_unique) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_t <- rbind(prox_genes_t, gene_chr)
}

prox_genes_t<- subset(prox_genes_t, prox_genes_t$gene_id %in% unlist(t_acu.hec_g_up))
hist(prox_genes_t$start)
ggplot(prox_genes_t, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

t_hec.cin_g_up <- list(row.names(subset(contrast_hec.cin3_RUV_t, contrast_hec.cin3_RUV_t$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin3_RUV_t),"g"))),
                        row.names(subset(contrast_hec.cin4_RUV_t, contrast_hec.cin4_RUV_t$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin4_RUV_t),"g"))))
t_hec.cin_g_up <- unique(unlist(t_hec.cin_g_up))
t_hec.cin_m_up_unique <-unlist(str_split(unlist(t_hec.cin_m_up),":")[1:length(unlist(t_hec.cin_m_up))])[seq(1,length(unlist(t_hec.cin_m_up)),4)] 

t_hec.cin_m_up_unique <- subset(t_hec.cin_m_up_unique,t_hec.cin_m_up_unique %in% TEs_gtf$TE_id)

prox_genes_hec.cin_t <- c()
for (i in t_hec.cin_m_up_unique) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_hec.cin_t <- rbind(prox_genes_hec.cin_t, gene_chr)
}

prox_genes_hec.cin_t<- subset(prox_genes_hec.cin_t, prox_genes_hec.cin_t$gene_id %in% unlist(t_hec.cin_g_up))
hist(prox_genes$start)
ggplot(prox_genes_hec.cin_t, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

### Liver ####
l_acu.hec_g_up_F <- list(row.names(subset(contrast_hec.cin8_RUV_l, contrast_hec.cin8_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin8_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin10_RUV_l, contrast_hec.cin10_RUV_l$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin10_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin17_RUV_l, contrast_hec.cin17_RUV_l$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin17_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin18_RUV_l, contrast_hec.cin18_RUV_l$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin18_RUV_l),"g"))))
l_acu.hec_g_up_F <- unique(unlist(l_acu.hec_g_up_F))
l_acu.hec_m_up_unique_F <-unlist(str_split(unlist(l_acu.hec_m_up_F),":")[1:length(unlist(l_acu.hec_m_up_F))])[seq(1,length(unlist(l_acu.hec_m_up_F)),4)] 

l_acu.hec_m_up_unique_F <- subset(l_acu.hec_m_up_unique_F,l_acu.hec_m_up_unique_F %in% TEs_gtf$TE_id)

prox_genes_acu.hec_l_F <- c()
for (i in l_acu.hec_m_up_unique_F) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_acu.hec_l_F <- rbind(prox_genes_acu.hec_l_F, gene_chr)
}

prox_genes_acu.hec_l_F<- subset(prox_genes_acu.hec_l_F, prox_genes_acu.hec_l_F$gene_id %in% unlist(l_acu.hec_g_up_F))
hist(prox_genes_acu.hec_l_F$start)
ggplot(prox_genes_acu.hec_l_F, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

l_hec.cin_g_up_F <- list(row.names(subset(contrast_hec.cin6_RUV_l, contrast_hec.cin6_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin6_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin4_RUV_l, contrast_hec.cin4_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin4_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin15_RUV_l, contrast_hec.cin15_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin15_RUV_l),"g"))),
                        row.names(subset(contrast_hec.cin16_RUV_l, contrast_hec.cin16_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin16_RUV_l),"g"))))
l_hec.cin_g_up_F <- unique(unlist(l_hec.cin_g_up_F))
l_hec.cin_m_up_unique_F <-unlist(str_split(unlist(l_hec.cin_m_up_F),":")[1:length(unlist(l_hec.cin_m_up_F))])[seq(1,length(unlist(l_hec.cin_m_up_F)),4)] 

l_hec.cin_m_up_unique_F <- subset(l_hec.cin_m_up_unique_F,l_hec.cin_m_up_unique_F %in% TEs_gtf$TE_id)

prox_genes_hec.cin_l_F <- c()
for (i in l_hec.cin_m_up_unique_F) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_hec.cin_l_F <- rbind(prox_genes_hec.cin_l_F, gene_chr)
}

prox_genes_hec.cin_l_F<- subset(prox_genes_hec.cin_l_F, prox_genes_hec.cin_l_F$gene_id %in% unlist(l_hec.cin_g_up_F))
hist(prox_genes_hec.cin_l_F$start)
ggplot(prox_genes_hec.cin_l_F, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

### Liver M ####
l_acu.hec_g_up_M <- list(row.names(subset(contrast_hec.cin7_RUV_l, contrast_hec.cin7_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin7_RUV_l),"g"))),
                       row.names(subset(contrast_hec.cin9_RUV_l, contrast_hec.cin9_RUV_l$log2FoldChange > 0& str_detect(row.names(contrast_hec.cin9_RUV_l),"g"))))
l_acu.hec_g_up_M <- unique(unlist(l_acu.hec_g_up_M))
l_acu.hec_m_up_unique_M <-unlist(str_split(unlist(l_acu.hec_m_up),":")[1:length(unlist(l_acu.hec_m_up))])[seq(1,length(unlist(l_acu.hec_m_up)),4)] 

l_acu.hec_m_up_unique_M <- subset(l_acu.hec_m_up_unique_M,l_acu.hec_m_up_unique_M %in% TEs_gtf$TE_id)

prox_genes_acu.hec_l_M <- c()
for (i in l_acu.hec_m_up_unique_M) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_acu.hec_l_M <- rbind(prox_genes_acu.hec_l_M, gene_chr)
}

prox_genes_acu.hec_l_M<- subset(prox_genes_acu.hec_l_M, prox_genes_acu.hec_l_M$gene_id %in% unlist(l_acu.hec_g_up_M))
hist(prox_genes_acu.hec_l_M$start)
ggplot(prox_genes_acu.hec_l_M, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

l_hec.cin_g_up_M <- list(row.names(subset(contrast_hec.cin3_RUV_l, contrast_hec.cin3_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin3_RUV_l),"g"))),
                       row.names(subset(contrast_hec.cin5_RUV_l, contrast_hec.cin5_RUV_l$log2FoldChange > 0 & str_detect(row.names(contrast_hec.cin5_RUV_l),"g"))))
l_hec.cin_g_up_M <- unique(unlist(l_hec.cin_g_up_M))
l_hec.cin_m_up_unique_M <-unlist(str_split(unlist(l_hec.cin_m_up),":")[1:length(unlist(l_hec.cin_m_up))])[seq(1,length(unlist(l_hec.cin_m_up)),4)] 

l_hec.cin_m_up_unique_M <- subset(l_hec.cin_m_up_unique_M,l_hec.cin_m_up_unique_M %in% TEs_gtf$TE_id)

prox_genes_hec.cin_l_M <- c()
for (i in l_hec.cin_m_up_unique_M) {
  gene_chr <- subset(genes_gtf, genes_gtf$chr == TEs_gtf$chr[which(TEs_gtf$TE_id==i)])
  gene_chr <- subset(gene_chr, gene_chr$start > TEs_gtf$start[which(TEs_gtf$TE_id==i)]-10000 & gene_chr$start < TEs_gtf$end[which(TEs_gtf$TE_id==i)]+10000)
  gene_chr$start <- gene_chr$start - TEs_gtf$start[which(TEs_gtf$TE_id==i)]
  prox_genes_hec.cin_l_M <- rbind(prox_genes_hec.cin_l_M, gene_chr)
}

prox_genes_hec.cin_l_M<- subset(prox_genes_hec.cin_l_M, prox_genes_hec.cin_l_M$gene_id %in% unlist(l_hec.cin_g_up_M))
hist(prox_genes$start)
ggplot(prox_genes_hec.cin_l_M, aes(x=start))+geom_density(adjust = 1/3)+theme_bw()#+scale_x_continuous(limits = c(-10000,10000))

prox_genes$Sample <- 1
prox_genes_hec.cin$Sample <- 2
prox_genes_t$Sample <- 3
prox_genes_hec.cin_t$Sample <- 4
prox_genes_acu.hec_l_M$Sample <- 5
prox_genes_acu.hec_l_F$Sample <- 6
prox_genes_hec.cin_l_M$Sample <- 7
prox_genes_hec.cin_l_F$Sample <- 8

prox_genes_all <- rbind(prox_genes_acu.hec_l_F,prox_genes_acu.hec_l_M,prox_genes_hec.cin,prox_genes_hec.cin_l_F,prox_genes_hec.cin_l_M,prox_genes_hec.cin_t,prox_genes_t,prox_genes)
prox_genes_all <- unique(prox_genes_all)
prox_genes_all$State <- NA
prox_genes_all$State[which(prox_genes_all$start > 0)]<- "Downstream"
prox_genes_all$State[which(prox_genes_all$start < 0)]<- "Upstream"
prox_genes_all <- prox_genes_all %>% group_by(Sample, State) %>% summarise(counts = n())
prox_genes_all_hc <- subset(prox_genes_all, prox_genes_all$Sample %in% c(2,4,7,8))

ggplot(prox_genes_all_hc, aes(x=State, y = counts))+geom_boxplot(aes(color=State), alpha = 0.5)+theme_bw()+ geom_pwc(
  method = "t_test", label = "p.signif",
  bracket.nudge.y = 0.1
)

genes_total <- list(l_acu.hec_g_up_M, l_acu.hec_g_up_F, l_hec.cin_g_up_M, l_hec.cin_g_up_F,
                t_acu.hec_g_up,t_hec.cin_g_up,ov_acu.hec_g_up,ov_hec.cin_g_up)
length(unique(unlist(genes_total)))


#### WCGNA #########
BiocManager::install("WGCNA")
library(WGCNA)
ocm <- t(counts(dds_o_RUV)) 
power <- c(c(1:10), seq(from = 12, to =50, by =2))
sft <- pickSoftThreshold(ocm, powerVector = power,
                         networkType = "signed",
                         verbose = 5)
sft.data <- sft$fitIndices

## visualize ##
p1 <- ggplot(sft.data, aes(Power, SFT.R.sq, label=Power))+geom_point()+
  geom_text(nudge_y = 0.1)+
  geom_hline(yintercept = 0.8, color = "red")+
  labs(x= "Power", y= "Scale free topology fit, R^2")+theme_bw()

p2 <- ggplot(sft.data, aes(Power, mean.k., label=Power))+geom_point()+
  geom_text(nudge_y = 0.1)+
  labs(x= "Power", y= "Mean connectivity")+theme_bw()

ggarrange(p1,p2, ncol = 1)

### power 12 ###

ocm[]<- sapply(ocm,as.numeric)

soft_power <- 12
temp_cor <- cor
cor <- WGCNA::cor

### Try blockwise module 
bwnet <- blockwiseModules(ocm, maxBlockSize = 40000,
                 TOMType = "signed",
                 power = soft_power,
                 mergeCutHeight = 0.25,
                 numericLabels = FALSE,
...
plotDendroAndColors(bwnet$dendrograms[[1]], cbind(bwnet$unmergedColors,bwnet$colors),
                    ...
                    hang = 0.03,
                    guideHang = 0.05)
ovaries_meta$x <- as.numeric(ovaries_meta$x)
traits_o <- ovaries_meta$x
w_traits <- binarizeCategoricalColumns(ovaries_meta$group,
                                       includePairwise = FALSE,
                                       includeLevelVsAll = TRUE,
                                       minCount = 1)
traits_o <- cbind(traits_o, w_traits)


###
nSamples <- nrow(traits_o)
nGenes <- ncol(ocm)

module_corr_o <- cor(mod_eigengenes, traits_o, use = "p")
module_traits_corr_pvals <- corPvalueStudent(module_corr_o, nSamples)
row.names(traits_o) <- row.names(mod_eigengenes)

### Visualize association with hybrid types ###
module_traits_corr_pvals$ME <- row.names(module_traits_corr_pvals)
mod_trait_cor_melt <- melt(as.data.table(module_traits_corr_pvals), id = "ME")
cor_plot_MEs <-ggplot(mod_trait_cor_melt, aes(x=variable, y=ME))+geom_tile(aes(fill=value))
module_traits_corr_pvals <- as.data.frame(module_traits_corr_pvals)
ov_4_acu_sigmods <- row.names(subset(module_traits_corr_pvals, module_traits_corr_pvals$data.4_acu.vs.all < 0.05))
ov_4_hec_sigmods <- row.names(subset(module_traits_corr_pvals, module_traits_corr_pvals$data.4_hec.vs.all < 0.05))
ov_5_hec_sigmods <- row.names(subset(module_traits_corr_pvals, module_traits_corr_pvals$data.5_hec.vs.all < 0.05))
ov_5_cin_sigmods <- row.names(subset(module_traits_corr_pvals, module_traits_corr_pvals$data.5_cin.vs.all < 0.05))
  
module_membership_m<- cor(mod_eigengenes, ocm, use = 'p')
module_membership_pvals <- corPvalueStudent(module_membership_m, nSamples)
dim(module_membership_pvals)

ov_4_acu_modmems <- subset(module_membership_pvals,row.names(module_membership_pvals) %in% ov_4_acu_sigmods)
dim(ov_4_acu_modmems)

### Try hub gene function
hubs_ov4_acu <- chooseTopHubInEachModule(ocm, colorh=ov_4_acu_sigmods)
hubs_ov4_hec <- chooseTopHubInEachModule(ocm, colorh=ov_4_hec_sigmods)
hubs_ov5_hec <- chooseTopHubInEachModule(ocm, colorh=ov_5_hec_sigmods)
hubs_ov5_cin <- chooseTopHubInEachModule(ocm, colorh=ov_5_cin_sigmods)

ov_g_signif <- cor(ocm, traits_o$data.4_acu.vs.all, use = 'p')
ov_g_signif_pvals <- corPvalueStudent(ov_g_signif, nSamples) 

dim(ov_g_signif_pvals)
...
mod_mem_matrix_4_acu<- ov_4_acu_modmems %>%
  as.data.frame() %>%
  t()
mod_mem_matrix_4_acu<-as.data.frame(mod_mem_matrix_4_acu)
mod_mem_matrix_4_acu$trait_pvals <- unlist(ov_g_signif_pvals)[,1] 
mod_hubs_darkol <- mod_mem_matrix_4_acu %>% subset(mod_mem_matrix_4_acu$MEdarkolivegreen > 0.8 &
                          mod_mem_matrix_4_acu$trait_pvals < 0.01) %>%
  arrange(desc(MEdarkolivegreen)) %>%
  head(50)
sum(str_detect(row.names(mod_hubs_darkol), "RND"))
sum(bwnet$colors != "grey" & str_detect(names(bwnet$colors), "RND"))

### Testes ####
tcm <- t(counts(dds_t_RUV)) 
power <- c(c(1:10), seq(from = 12, to =50, by =2))
sft <- pickSoftThreshold(tcm, powerVector = power,
                         networkType = "signed",
                         verbose = 5)
sft.data <- sft$fitIndices
...
### Try blockwise module 
bwnet_t <- blockwiseModules(tcm, maxBlockSize = 40000,
                          TOMType = "signed",
                          power = soft_power,
                          mergeCutHeight = 0.25,
                          numericLabels = FALSE,
...
mod_eigengenes_t <- bwnet_t$MEs
plotDendroAndColors(bwnet_t$dendrograms[[1]], cbind(bwnet_t$unmergedColors,bwnet_t$colors),
                    c("unmerged","merged"),
                    dendroLabels = F,
                    addGuide=T,
                    hang = 0.03,
